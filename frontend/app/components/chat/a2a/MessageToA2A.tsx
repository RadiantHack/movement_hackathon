...
export const MessageToA2A: React.FC<MessageActionRenderProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-200 dark:border-green-800 rounded-lg sm:rounded-xl px-2.5 py-2 sm:px-4 sm:py-4 md:px-5 md:py-4 my-2 sm:my-3 shadow-sm hover:shadow-md transition-shadow a2a-message-enter max-w-full overflow-hidden">
      ...
      <div className="space-y-1.5 sm:space-y-3">
        ...
        <div className="mt-2 sm:mt-4 pt-1.5 sm:pt-3 border-t border-green-200 dark:border-green-800">
          <div className="text-center px-0.5 sm:px-0">
            ...
            <p
              className="text-[10px] sm:text-sm text-gray-800 dark:text-gray-200 break-words leading-relaxed"
              title={args.task}
            >
              {args.task}
            </p>
