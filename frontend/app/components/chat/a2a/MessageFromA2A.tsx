    ...
    <div className="my-2 sm:my-3 w-full max-w-full">
      <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/20 dark:to-cyan-950/20 border border-blue-200 dark:border-blue-800 rounded-lg sm:rounded-xl px-2.5 py-2 sm:px-3 sm:py-3 md:px-4 md:py-4 shadow-sm hover:shadow-md transition-shadow w-full max-w-full overflow-hidden">
        ...
        <div className="space-y-1.5 sm:space-y-3">
          ...
          <div className="flex items-center justify-center gap-1 sm:gap-2 md:gap-3 flex-wrap">
            ...
            <div className="flex items-center relative px-0.5 sm:px-2">
              ...
              <div className="relative w-6 h-4 sm:w-10 sm:h-6 md:w-12 md:h-6 flex items-center justify-center overflow-visible">
                ...
                <svg
                  className="w-3 h-3 sm:w-5 sm:h-5 md:w-6 md:h-6 text-blue-500 dark:text-blue-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div className="mt-2 sm:mt-4 pt-1.5 sm:pt-3 border-t border-blue-200 dark:border-blue-800">
            <div className="text-center px-0.5 sm:px-0">
              <div className="inline-flex items-center gap-1 sm:gap-2 px-1.5 py-0.5 sm:px-3 sm:py-1.5 rounded-full bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700">
                <svg
                ...
                <span className="text-[9px] sm:text-xs font-semibold text-green-700 dark:text-green-300">
                  Response received
                </span>
              </div>
            </div>
